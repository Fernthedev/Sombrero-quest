...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DSOMBRERO_DEBUG='1' -DHAS_CODEGEN -DID='"sombrero"' -DVERSION='"0.1.27"' -I'./shared' -I'./extern' -isystem'extern/codegen/include' -O2
